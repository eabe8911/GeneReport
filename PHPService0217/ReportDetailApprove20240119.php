    ...
    try {
        ...
        switch ($ApproveMode) {
            case 'REJECT':
                ...
                $log->SaveLog("REJECT", $Username, "ReportDetailApprove", date("Y-m-d H:i:s"), $logDataJson);
            ...
            case 'PASS':
                ...
                if ($report->Approve($_POST, $_SESSION)) {
                    ...
                    $logDataJson = json_encode($logData, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
                    $log->SaveLog("PASS", $Username, "ReportDetailApprove", date("Y-m-d H:i:s"), $logDataJson);

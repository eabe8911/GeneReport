                    ...
                    <div class="row">
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <!--MEMBER NAME FIELD , THIS FIELD IS CONNECTED TO HOME.PHP-->
                                    <label for="Approved1At" class="col-md-3 control-label">實驗室核准日期:</label>
                                    <div class="col-md-8">
                                ...
                                <!---- 醫師核准日期 ---->
                                <div class="form-group">
                                    <label for="Approved2At" class="col-md-3 control-label">醫師核准日期:</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <!--MEMBER NAME FIELD , THIS FIELD IS CONNECTED TO HOME.PHP-->
                                    <label for="Reject1At" class="col-md-3 control-label">實驗室退回日期:</label>
                                    <div class="col-md-8">
                                ...
                                <!---- 醫師核准日期 ---->
                                <div class="form-group">
                                    <label for="Reject2At" class="col-md-3 control-label">醫師退回日期:</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="RejectReason" name=RejectReason class="form-control" value="{$RejectReason}" readonly>
                        ...
                        <!-- <div class="form-horizontal" role="form">
                            ...
                            <div class="col-md-12">
                                {if $PDFPreview neq '請再上傳一次報告'}
                                    <embed id='PDFPreview' name='PDFPreview' src='{$PDFPreview}' type='application/pdf' width='100%' height='1000px' />
                                {else}

            ...
            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="CustomerPhone" name="CustomerPhone" class="form-control"
                                            required value="{$CustomerPhone}" readonly>
                                    </div>
                                </div>
                                <!---- 報告發送狀態 ---->
                ...
                <div>
                    <div id="ds1" align="center">
                        ...
                        {if $ReportStatus == '0' || $ReportStatus == '10'}
                ...
                <div class="row" id="PDFArea">
                    ...
                    <div class="col-md-12">
                        ...
                        <embed id='PDFPreview' name='PDFPreview' src='{$PDFPreview}' type='application/pdf' width='100%'
                            height='1000px' />
                        {else}

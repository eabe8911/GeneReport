...
<body>
    ...
    <form action="Addsample.php" name="Addsample" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <!-- <input type="text" id="Nanodrop_Yield" name="Nanodrop_Yield"
                                            ...
                                            <input type="text" id="Nanodrop_Yield" name="Nanodrop_Yield" class="form-control" required readonly>
                                    </div>
                                </div>
...
<script>
    // Function to update Nanodrop_Yield based on Nanodrop_Conc and Volume
    function updateYield() {
        var conc = document.getElementById('Nanodrop_Conc').value;
        var volume = document.getElementById('Volume').value;
        var yield = conc * volume;  // Calculate yield as concentration * volume
        document.getElementById('Nanodrop_Yield').value = yield;  // Set the value of Nanodrop_Yield
    }

    // Attach event listeners to update yield when inputs change
    document.getElementById('Nanodrop_Conc').addEventListener('input', updateYield);
    document.getElementById('Volume').addEventListener('input', updateYield);
</script>
</html>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        jQuery("#jqGrid").jqGrid({
            ...
            url: "GetReportList.php?userid=" + UserID + "&permission=" + Permission + "&role=" + Role + "&character=" + Character + "&customerName=" + CustomerName,
            datatype: "json",
            width: Width,
            height: Height,
            //autowidth: true,
            ...
            colModel: [
                ...
                { label: "實驗室審核", name: "Approved1", width: "4%", align: "center" },
                ...
                { label: "醫師審核", name: "Approved2", width: '4%', align: "center" },
